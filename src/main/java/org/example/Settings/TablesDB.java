...
public final class TablesDB {
    ...
    public static final String QUIZ_QUESTION_TABLE = "public.quiz_questions";
    public static final String QUIZ_ANSWERS_TABLE = "public.quiz_answers";
    public static final String QUIZ_STATS_TABLE = "public.quiz_stats";
